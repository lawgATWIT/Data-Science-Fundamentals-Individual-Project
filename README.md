...
* pandas for making data subsets that can be used to compare and contrast trends to analyze correlation
* matplotlib for creating data visualizations, that allows for a predictive pattern of future data to be calculated. 
* Scikit - A machine learning library for python called Scikit was also utilized to produced linear regression models for the data. 
